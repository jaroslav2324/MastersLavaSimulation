...
namespace Tuner::TunerHelper
{
        ...
        const GPUSorting::MODE &gpuSortMode)
    {
        ...
        if (result != table.end())
        {
            tuningParams = gpuSortMode == GPUSorting::MODE_KEYS_ONLY ? TunerHelper::calcKeysTuningParametersNvidia(devInfo, result->second) : TunerHelper::calcPairsTuningParametersNvidia(devInfo, result->second);
        }
        else
        {
#ifdef _DEBUG
        ...
        const GPUSorting::MODE &gpuSortMode)
    {
        ...
        if (result != table.end())
        {
            tuningParams = gpuSortMode == GPUSorting::MODE_KEYS_ONLY ? TunerHelper::calcKeysTuningParametersRDNA() : TunerHelper::calcPairsTuningParametersRDNA();
        }
        else
        {
#ifdef _DEBUG
